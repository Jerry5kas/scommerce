...
export default function AdminCategoriesCreate({ verticalOptions }: AdminCategoriesCreateProps) {
    ...
    const form = useForm({
        name: '', slug: '', description: '', image: '', image_file: null as File | null,
        icon: '', display_order: 0, is_active: true, vertical: 'both',
                    ...
                    if (imageFile) {
                        ...
                        try {
                            ...
                            if (uploadResult.success && uploadResult.url) {
                                form.setData('image', uploadResult.url); form.setData('image_file', null); setImageFile(null);
            ...
            >
                ...
                <Section title="Media">
                    <div>
                        ...
                        <input type="text" placeholder="https://example.com/image.jpg" className={inputCls} value={form.data.image} onChange={(e) => { form.setData('image', e.target.value); if (e.target.value) { setImageFile(null); setImagePreview(null); form.setData('image_file', null); if (fileInputRef.current) fileInputRef.current.value = ''; } }} disabled={!!imageFile} />
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Link href="/admin/categories" className="rounded-lg border border-gray-300 px-5 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50">Cancel</Link>
                </div>
            </form>
        </AdminLayout>
    );
