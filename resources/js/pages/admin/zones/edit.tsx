                    ...
                    <div className="grid gap-8 lg:grid-cols-2">
                        <div className="space-y-6">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-gray-500">Update the name and city/state for this zone.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-sm text-gray-500">Verticals and pincodes define the coverage for this zone.</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p className="mt-0.5 text-xs text-gray-500">
                                    You can type pincodes separated by commas or place each one on a new line.
                                </p>
                                <textarea
                                    rows={3}
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-gray-500">Control which days and times you deliver in this zone.</p>
                            </div>
                            <div>
                            ...
                            <div className="rounded-lg border border-dashed border-gray-200 bg-gray-50 p-4">
                                ...
                                <p className="mt-1 text-xs text-gray-500">
                                    If you are not using a drawn map area, you can leave this blank. For advanced setups, keep or paste a JSON array of
                                    [lat, lng] points that outline the zone.
                                </p>
                                <textarea
                                    rows={4}
                                    className="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 font-mono text-sm shadow-sm"
