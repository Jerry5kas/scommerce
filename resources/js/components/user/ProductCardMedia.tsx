...
export function getMediaList(
    product: { image: string; media?: MediaItem[] },
): MediaItem[] {
            ...
            {hasMultiple && (
                <>
                    <button
                        ...
                        className="absolute left-0 top-1/2 z-10 flex h-6 w-6 -translate-y-1/2 items-center justify-center rounded-full bg-white/90 shadow-sm opacity-0 transition-opacity hover:bg-white group-hover:opacity-100 sm:left-1 sm:h-7 sm:w-7"
                    >
                    ...
                    <button
                        ...
                        className="absolute right-0 top-1/2 z-10 flex h-6 w-6 -translate-y-1/2 items-center justify-center rounded-full bg-white/90 shadow-sm opacity-0 transition-opacity hover:bg-white group-hover:opacity-100 sm:right-1 sm:h-7 sm:w-7"
                    >
                        <ChevronRight className="h-3 w-3 text-gray-700 sm:h-4 sm:w-4" strokeWidth={2.5} />
                    </button>
                    <div className="absolute bottom-1 left-0 right-0 z-10 flex justify-center gap-1 sm:bottom-1.5">
                        {media.map((_, i) => (
                            <button
                                key={i}
                                type="button"
