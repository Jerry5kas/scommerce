...
const BottleController = { index, create, store, show, edit, update, destroy, issue, returnMethod, markDamaged, markLost, logs, reports, scanBarcode, return: returnMethod }
