...
/**
* @see \App\Http\Controllers\Admin\LoyaltyController::adjustPoints
 * @see app/Http/Controllers/Admin/LoyaltyController.php:0
 * @route '/admin/loyalty/{loyaltyPoint}/adjust'
 */
export const adjustPoints = (args: { loyaltyPoint: string | number } | [loyaltyPoint: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: adjustPoints.url(args, options),
    method: 'post',
})

adjustPoints.definition = {
    methods: ["post"],
 ...
 * @route '/admin/loyalty/{loyaltyPoint}/adjust'
 */
adjustPoints.url = (args: { loyaltyPoint: string | number } | [loyaltyPoint: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { loyaltyPoint: args }
    }
    ...
    return adjustPoints.definition.url
            .replace('{loyaltyPoint}', parsedArgs.loyaltyPoint.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/admin/loyalty/{loyaltyPoint}/adjust'
 */
adjustPoints.post = (args: { loyaltyPoint: string | number } | [loyaltyPoint: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: adjustPoints.url(args, options),
    method: 'post',
})
...
const LoyaltyController = { index, show, adjustPoints, toggleStatus, transactions }
